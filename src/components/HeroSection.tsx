      ...
      <div className = 'container max-w-4xl mx-auto text-center z-10'>
        <div className ='space-y-6'>
          <h1 className = 'text-4xl md:text-6xl font-bold tracking-tight'>
            ...
            <span className = 'text-primary opacity-0 animate-fade-in-delay-1'>Sophia, </span>
            <span className = 'text-foreground opacity-0 animate-fade-in-delay-2'>web developer :)</span>
          </h1>
          ...
          <div className = "opacity-0 animate-fade-in-delay-4">
            <a href="#projects" className = "dark:bg-primary dark:purple-hover cosmic-button">
